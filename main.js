...
document.getElementById("challengeArt").innerHTML='Sketch To Be Drawn : '+sketch;
timer_counter=0;
timer_check="";
draw_sketch="";
answer_holder="";
...
function gotResult(error,results){
    if(error){
      ...
      console.log("results");
      draw_sketch=classifyCanvas;
      document.getElementById("guess_").innerHTML=draw_sketch;
        document.getElementById("confidence_").innerHTML=results[0].confidence.toFixed(2);
